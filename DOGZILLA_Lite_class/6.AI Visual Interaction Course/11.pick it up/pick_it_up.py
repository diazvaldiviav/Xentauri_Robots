...
pos = 210 #小球夹取角度，夹取木块参数改为260,根据夹取的木块大小调节 0：完全打开 #Adjust the size of the clamped wooden block to 0: fully open
...
try:
    while 1:
        ...
        if g_mode == 1:
            ...
            time.sleep(0.5)
            g_dog.motor([52,53],[-10,80]) #直接角度控制吧 #g_dog.arm(armx,-85)  #-45 -20
            time.sleep(2)
